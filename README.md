...
The code is based on [this repository](https://github.com/kaandocal/twoclock). It consists of `sim.jl`, which is used to simulate populations with a fixed carrying capacity, and a model `plasmid.jl`.
